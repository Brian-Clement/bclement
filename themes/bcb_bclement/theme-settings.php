 ...
 */
function bcb_bclement_form_system_theme_settings_alter(&$form, FormStateInterface $form_state, $form_id = NULL) {
  ...
  $form['instant_vertical_tabs'] = array(
    '#type' => 'vertical_tabs',
    '#prefix' => '<h2><small>' . t('BClement settings') . '</small></h2>',
  );
  ...
  foreach ($social_networks as $key => $name) {
    $key_name = 'bcb_bclement_social_' . $key;
